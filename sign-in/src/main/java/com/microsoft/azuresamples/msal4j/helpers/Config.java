...
public class Config {
    ...
    private static Properties instantiateProperties() {
        ...
        try {
            Config.logger.log(Level.INFO, "Fetching properties...");
            propsLocal.load(Config.class.getClassLoader().getResourceAsStream("authentication.properties"));
            Config.logger.log(Level.INFO, propsLocal.toString());
